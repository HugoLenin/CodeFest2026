...
Debido al tamaño de algunos archivos binarios de la base vectorial (index.faiss, metadata.jsonl y grafo.graphml), estos fueron almacenados mediante Git LFS. El archivo .gitattributes ubicado en la raíz del repositorio contiene la configuración necesaria para identificar dichos archivos.
